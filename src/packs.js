...
export const THEMED_PACKS = [
  ...
  },
  {
    ...
    tasks: {
      fr: ["Boire au moins 2L d'eau", "Marcher au soleil 15 min", "Manger un fruit frais", "Se baigner ou se rafraîchir", "Faire des étirements", "Prendre une photo de la nature", "Déjeuner dehors", "Regarder le coucher de soleil"],
      en: ["Drink at least 2L of water", "Walk in the sun 15 min", "Eat fresh fruit", "Swim or cool off", "Do some stretches", "Take a nature photo", "Eat lunch outside", "Watch the sunset"],
      es: ["Bebe al menos 2L de agua", "Camina al sol 15 min", "Come fruta fresca", "Nada o refréscate", "Haz estiramientos", "Toma una foto de la naturaleza", "Almuerza afuera", "Mira el atardecer"],
    },
  },
  {
    id: "autumn_reset",
