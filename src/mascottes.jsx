...
export const ENERGIES = [
  {
    ...
    bio: { fr: "Chaiti vit près des temples fleuris, parmi les jardins parfumés. Il aime les pétales sucrés et l'eau fraîche des bassins. Calme et bienveillant, il avance avec douceur et porte chance à ceux qu'il croise.", en: "Chaiti lives near flowery temples, among fragrant gardens. It loves sweet petals and the cool water of the ponds. Calm and kind, it moves gently and brings luck to those it meets.", es: "Chaiti vive cerca de templos floridos, entre jardines perfumados. Le encantan los pétalos dulces y el agua fresca de los estanques. Tranquilo y amable, avanza con suavidad y trae suerte a quien encuentra." },
    inspiration: { fr: "Son inspiration : le sourire thaï — accueillir chaque jour avec sérénité.", en: "Its inspiration: the Thai smile — welcoming each day with serenity.", es: "Su inspiración: la sonrisa tailandesa — recibir cada día con serenidad." },
  },
  {
    level: 2,
    ...
    bio: { fr: "Jaiki vit là où tout va vite, entre gratte-ciels et circuits lumineux. Il carbure aux idées neuves et à l'énergie électrique. Vif et audacieux, il fonce vers l'avenir sans jamais douter.", en: "Jaiki lives where everything moves fast, among skyscrapers and glowing circuits. It runs on fresh ideas and electric energy. Quick and bold, it races toward the future without a doubt.", es: "Jaiki vive donde todo va rápido, entre rascacielos y circuitos luminosos. Se alimenta de ideas nuevas y energía eléctrica. Vivo y audaz, corre hacia el futuro sin dudar." },
    inspiration: { fr: "Son inspiration : oser — tenter de nouvelles choses sans peur de l'échec.", en: "Its inspiration: to dare — trying new things without fear of failure.", es: "Su inspiración: atreverse — probar cosas nuevas sin miedo al fracaso." },
  },
  {
    level: 3,
    ...
    bio: { fr: "Bayki vit dans les grandes plaines baignées de lumière. Il aime la chaleur du jour et le partage autour du feu. Fier et généreux, il réchauffe le cœur de tous ceux qui l'entourent.", en: "Bayki lives in the wide plains bathed in light. It loves the warmth of the day and sharing around the fire. Proud and generous, it warms the hearts of all around it.", es: "Bayki vive en las grandes llanuras bañadas de luz. Le gusta el calor del día y compartir alrededor del fuego. Orgulloso y generoso, calienta el corazón de quienes lo rodean." },
    inspiration: { fr: "Son inspiration : la teranga — l'hospitalité et le partage sénégalais.", en: "Its inspiration: teranga — Senegalese hospitality and sharing.", es: "Su inspiración: la teranga — la hospitalidad y generosidad senegalesa." },
  },
  {
    level: 4,
    ...
    bio: { fr: "Joaki vit au fil des courants, entre ports et grand large. Il aime l'air salé et les longues traversées vers l'inconnu. Curieux et tenace, il garde toujours le cap, guidé par les étoiles.", en: "Joaki lives along the currents, between harbors and open sea. It loves the salty air and long crossings toward the unknown. Curious and tenacious, it always holds its course, guided by the stars.", es: "Joaki vive al ritmo de las corrientes, entre puertos y mar abierto. Le gusta el aire salado y las largas travesías hacia lo desconocido. Curioso y tenaz, siempre mantiene el rumbo, guiado por las estrellas." },
    inspiration: { fr: "Son inspiration : l'esprit d'exploration — partir à la découverte du monde.", en: "Its inspiration: the spirit of exploration — setting off to discover the world.", es: "Su inspiración: el espíritu de exploración — salir a descubrir el mundo." },
  },
  {
    level: 5,
    ...
    bio: { fr: "Renki vit dans le calme des nuits claires, sous la lumière argentée. Il aime le silence et la rosée du soir. Sage et malicieux, il observe le monde avec patience.", en: "Renki lives in the calm of clear nights, under silvery light. It loves silence and the evening dew. Wise and mischievous, it watches the world with patience.", es: "Renki vive en la calma de las noches claras, bajo la luz plateada. Le gusta el silencio y el rocío de la tarde. Sabio y travieso, observa el mundo con paciencia." },
    inspiration: { fr: "Son inspiration : l'ikigai — trouver ce qui donne du sens à chaque jour.", en: "Its inspiration: ikigai — finding what gives meaning to each day.", es: "Su inspiración: el ikigai — encontrar lo que da sentido a cada día." },
  },
  {
    level: 6,
    ...
    bio: { fr: "Emeki vit là où résonnent les tambours et les chants. Il aime le rythme, la danse et les fêtes animées. Joyeux et entraînant, il met de la vie partout où il passe.", en: "Emeki lives where drums and songs resound. It loves rhythm, dance and lively celebrations. Joyful and uplifting, it brings life wherever it goes.", es: "Emeki vive donde resuenan los tambores y los cantos. Le gusta el ritmo, el baile y las fiestas animadas. Alegre y contagioso, lleva vida a donde va." },
    inspiration: { fr: "Son inspiration : la joie partagée — célébrer la vie ensemble.", en: "Its inspiration: shared joy — celebrating life together.", es: "Su inspiración: la alegría compartida — celebrar la vida juntos." },
  },
  {
    level: 7,
    ...
    bio: { fr: "Weiki vit dans les montagnes brumeuses, gardien d'une flamme ancienne. Il aime le thé chaud et les feux d'artifice. Sage et puissant, il protège ceux qui lui font confiance.", en: "Weiki lives in the misty mountains, keeper of an ancient flame. It loves hot tea and fireworks. Wise and powerful, it protects those who trust it.", es: "Weiki vive en las montañas brumosas, guardián de una llama antigua. Le gusta el té caliente y los fuegos artificiales. Sabio y poderoso, protege a quienes confían en él." },
    inspiration: { fr: "Son inspiration : la persévérance — avancer pas à pas vers son but.", en: "Its inspiration: perseverance — moving step by step toward your goal.", es: "Su inspiración: la perseverancia — avanzar paso a paso hacia la meta." },
  },
  {
    level: 8,
    ...
    bio: { fr: "Freyki vit au bord des lacs gelés, là où l'air est pur. Il aime le confort douillet et les moments paisibles. Doux et serein, il transforme le froid en cocon chaleureux.", en: "Freyki lives by frozen lakes, where the air is pure. It loves cozy comfort and peaceful moments. Gentle and serene, it turns the cold into a warm cocoon.", es: "Freyki vive junto a lagos helados, donde el aire es puro. Le gusta la comodidad acogedora y los momentos tranquilos. Dulce y sereno, convierte el frío en un cálido refugio." },
    inspiration: { fr: "Son inspiration : le hygge — savourer les petits bonheurs simples.", en: "Its inspiration: hygge — savoring the simple little joys.", es: "Su inspiración: el hygge — disfrutar de los pequeños placeres simples." },
  },
  {
    level: 9,
    ...
    bio: { fr: "Floriti vit dans les eaux colorées, au milieu des guirlandes de fête. Il aime les couleurs vives et la musique entraînante. Espiègle et souriant, il transforme chaque jour en célébration.", en: "Floriti lives in colorful waters, among festive garlands. It loves bright colors and lively music. Playful and smiling, it turns every day into a celebration.", es: "Floriti vive en aguas coloridas, entre guirnaldas de fiesta. Le gustan los colores vivos y la música animada. Travieso y sonriente, convierte cada día en una celebración." },
    inspiration: { fr: "Son inspiration : la joie de vivre — fêter la vie sous toutes ses couleurs.", en: "Its inspiration: joie de vivre — celebrating life in all its colors.", es: "Su inspiración: la alegría de vivir — celebrar la vida en todos sus colores." },
  },
  {
    level: 10,
    ...
    bio: { fr: "Aminki vit dans les grandes dunes dorées, sous le ciel immense. Il aime l'ombre des oasis et le thé à la menthe. Endurant et patient, il avance sereinement, quelle que soit la distance.", en: "Aminki lives in the great golden dunes, under the vast sky. It loves the shade of oases and mint tea. Enduring and patient, it moves calmly, whatever the distance.", es: "Aminki vive en las grandes dunas doradas, bajo el cielo inmenso. Le gusta la sombra de los oasis y el té de menta. Resistente y paciente, avanza con calma, sin importar la distancia." },
    inspiration: { fr: "Son inspiration : la patience — avancer à son rythme, sans se presser.", en: "Its inspiration: patience — moving at your own pace, without rushing.", es: "Su inspiración: la paciencia — avanzar a su ritmo, sin prisa." },
  },
  {
    level: 11,
    ...
    bio: { fr: "Sparki vit là où souffle la brise, entre collines et côtes venteuses. Il aime les longues promenades et le thé de cinq heures. Têtu mais loyal, il garde son flegme en toute situation.", en: "Sparki lives where the breeze blows, between hills and windy coasts. It loves long walks and afternoon tea. Stubborn but loyal, it keeps its composure in any situation.", es: "Sparki vive donde sopla la brisa, entre colinas y costas ventosas. Le gustan los paseos largos y el té de la tarde. Terco pero leal, mantiene la calma en cualquier situación." },
    inspiration: { fr: "Son inspiration : le flegme — garder son calme face aux imprévus.", en: "Its inspiration: composure — staying calm in the face of the unexpected.", es: "Su inspiración: la flema — mantener la calma ante lo imprevisto." },
  },
  {
    level: 12,
    ...
    bio: { fr: "Matiki vit près des rivières tranquilles, après la pluie. Il aime se prélasser au soleil et la compagnie des autres. Zen et amical, il prend la vie avec une douceur communicative.", en: "Matiki lives by quiet rivers, after the rain. It loves basking in the sun and the company of others. Zen and friendly, it takes life with a contagious gentleness.", es: "Matiki vive cerca de ríos tranquilos, después de la lluvia. Le gusta tomar el sol y la compañía de los demás. Zen y amistoso, toma la vida con una dulzura contagiosa." },
    inspiration: { fr: "Son inspiration : la tranquilidad — rester serein et profiter du moment.", en: "Its inspiration: tranquilidad — staying serene and enjoying the moment.", es: "Su inspiración: la tranquilidad — mantener la serenidad y disfrutar el momento." },
  },
  {
    level: 13,
    ...
    bio: { fr: "Zorki vit dans les forêts profondes, là où la nuit s'étire. Il aime le silence et les grands espaces enneigés. Mystérieux mais fidèle, il protège les siens avec un cœur plus chaud qu'il n'y paraît.", en: "Zorki lives in deep forests, where the night stretches on. It loves silence and vast snowy spaces. Mysterious but faithful, it protects its own with a heart warmer than it seems.", es: "Zorki vive en bosques profundos, donde la noche se alarga. Le gusta el silencio y los grandes espacios nevados. Misterioso pero fiel, protege a los suyos con un corazón más cálido de lo que parece." },
    inspiration: { fr: "Son inspiration : la force tranquille — rester solide face à l'adversité.", en: "Its inspiration: quiet strength — staying solid in the face of adversity.", es: "Su inspiración: la fuerza tranquila — mantenerse firme ante la adversidad." },
  },
  {
    level: 14,
    ...
    bio: { fr: "Bimaki vit dans la canopée luxuriante, entre les grands arbres. Il aime les fruits mûrs et les siestes à l'ombre des feuilles. Curieux et paisible, il vit en harmonie avec la nature.", en: "Bimaki lives in the lush canopy, among the tall trees. It loves ripe fruit and naps in the shade of leaves. Curious and peaceful, it lives in harmony with nature.", es: "Bimaki vive en la copa frondosa, entre los árboles altos. Le gustan las frutas maduras y las siestas a la sombra de las hojas. Curioso y tranquilo, vive en armonía con la naturaleza." },
    inspiration: { fr: "Son inspiration : l'harmonie — vivre en équilibre avec ce qui nous entoure.", en: "Its inspiration: harmony — living in balance with what surrounds us.", es: "Su inspiración: la armonía — vivir en equilibrio con lo que nos rodea." },
  },
  {
    level: 15,
    ...
    bio: { fr: "Shamki vit sur les cimes escarpées, là où l'air est vif. Il aime les hauteurs et le silence des sommets. Solide et déterminé, il grimpe toujours plus haut, sans jamais vaciller.", en: "Shamki lives on steep peaks, where the air is crisp. It loves heights and the silence of summits. Solid and determined, it always climbs higher, never wavering.", es: "Shamki vive en cumbres escarpadas, donde el aire es vivo. Le gustan las alturas y el silencio de las cimas. Sólido y determinado, sube siempre más alto, sin vacilar." },
    inspiration: { fr: "Son inspiration : la ténacité — gravir ses montagnes une étape à la fois.", en: "Its inspiration: tenacity — climbing your mountains one step at a time.", es: "Su inspiración: la tenacidad — escalar tus montañas paso a paso." },
  },
  {
    level: 16,
    ...
    bio: { fr: "Luci vit parmi les ruines anciennes et les places ensoleillées. Il aime la bonne cuisine et les siestes au chaud. Élégant et gourmand, il savoure chaque instant avec style.", en: "Luci lives among ancient ruins and sunny squares. It loves good food and warm naps. Elegant and fond of treats, it savors every moment with style.", es: "Luci vive entre ruinas antiguas y plazas soleadas. Le gusta la buena comida y las siestas al calor. Elegante y goloso, saborea cada instante con estilo." },
    inspiration: { fr: "Son inspiration : la dolce vita — apprécier les plaisirs simples de la vie.", en: "Its inspiration: la dolce vita — enjoying life's simple pleasures.", es: "Su inspiración: la dolce vita — disfrutar de los placeres simples de la vida." },
  },
  {
    level: 17,
    ...
    bio: { fr: "Omari vit dans les vastes déserts dorés, libre comme le vent. Il aime les grandes courses et les nuits étoilées. Noble et fier, il avance avec grâce et élégance.", en: "Omari lives in the vast golden deserts, free as the wind. It loves great races and starry nights. Noble and proud, it moves with grace and elegance.", es: "Omari vive en los vastos desiertos dorados, libre como el viento. Le gustan las grandes carreras y las noches estrelladas. Noble y orgulloso, avanza con gracia y elegancia." },
    inspiration: { fr: "Son inspiration : la noblesse — agir avec dignité et générosité.", en: "Its inspiration: nobility — acting with dignity and generosity.", es: "Su inspiración: la nobleza — actuar con dignidad y generosidad." },
  },
  {
    level: 18,
    ...
    bio: { fr: "Welki vit dans les forêts ordonnées, près des ateliers. Il aime les choses bien faites et les rouages qui tournent juste. Méthodique et fiable, il mène chaque tâche jusqu'au bout.", en: "Welki lives in orderly forests, near the workshops. It loves things done well and gears that turn just right. Methodical and reliable, it sees every task through to the end.", es: "Welki vive en bosques ordenados, cerca de los talleres. Le gustan las cosas bien hechas y los engranajes que giran perfectos. Metódico y fiable, lleva cada tarea hasta el final." },
    inspiration: { fr: "Son inspiration : la rigueur — faire les choses avec soin et précision.", en: "Its inspiration: rigor — doing things with care and precision.", es: "Su inspiración: el rigor — hacer las cosas con cuidado y precisión." },
  },
  {
    level: 19,
    ...
    bio: { fr: "Kreoli vit sur les pentes volcaniques, là où la terre est chaude. Il aime le soleil et les fruits tropicaux. Vif et chaleureux, il déborde d'une énergie joyeuse et contagieuse.", en: "Kreoli lives on volcanic slopes, where the earth is warm. It loves the sun and tropical fruit. Lively and warm, it overflows with joyful, contagious energy.", es: "Kreoli vive en las laderas volcánicas, donde la tierra es cálida. Le gusta el sol y las frutas tropicales. Vivo y cálido, rebosa de una energía alegre y contagiosa." },
    inspiration: { fr: "Son inspiration : le métissage — mélanger les cultures dans la bonne humeur.", en: "Its inspiration: blending — mixing cultures with good cheer.", es: "Su inspiración: el mestizaje — mezclar culturas con buen humor." },
  },
  {
    level: 20,
    ...
    bio: { fr: "Lumi vit perché sur les hauteurs, face au soleil levant. Il aime les graines dorées et les premières lueurs du matin. Fier et loyal, il veille sur les autres Jokis et son chant réveille leur courage.", en: "Lumi lives perched on the heights, facing the rising sun. It loves golden seeds and the first light of morning. Proud and loyal, it watches over the other Jokis and its song awakens their courage.", es: "Lumi vive en las alturas, frente al sol naciente. Le gustan las semillas doradas y las primeras luces de la mañana. Orgulloso y leal, vela por los demás Jokis y su canto despierta su valor." },
    inspiration: { fr: "Son inspiration : l'art de vivre — savourer chaque instant.", en: "Its inspiration: the art of living — savoring every moment.", es: "Su inspiración: el arte de vivir — saborear cada instante." },
  },
];
